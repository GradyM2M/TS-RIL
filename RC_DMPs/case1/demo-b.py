...
if __name__ == "__main__":
    ...
    # 生成泛化轨迹
    x_rollout, _, _ = dmp.rollout(x0=[16,16.5,3],xT=[17.5,16.6,3])
    x_rollout2, _, _ = dmp.rollout_ECDMP(x0=[16,16.5,3],xT=[17.5,16.6,3])
    ...
    np.savetxt(r'D:\大论文\实验代码\Joing_dmps\numerical_test\case1\case1-2(dmp)',x_rollout)
    np.savetxt(r'D:\大论文\实验代码\Joing_dmps\numerical_test\case1\case1-2(ec-dmp)',x_rollout2)
