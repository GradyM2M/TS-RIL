...
if __name__ == "__main__":
    ...
    # 生成泛化轨迹
    x_rollout, _, _ = dmp.rollout(x0=[10,4.5,3],xT=[8.75,4.4,3])
    x_rollout2, _, _ = dmp.rollout_ECDMP(x0=[10,4.5,3],xT=[8.75,4.4,3])
    ...
    plt.legend(prop = {'size':8},bbox_to_anchor=(0.71,0.74),ncols=1)
    ...
    plt.savefig("case2-x.png",dpi=600)
    plt.show()
