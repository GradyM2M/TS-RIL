...
if __name__ == "__main__":
    ...
    # np.savetxt(r'D:\大论文\实验代码\Joing_dmps\numerical_test\case2\x_des', x_des)
    # np.savetxt(r'D:\大论文\实验代码\Joing_dmps\numerical_test\case2\dmp', x_rollout)
    np.savetxt(r'D:\大论文\实验代码\experiment3\case2\ec-dmp(Y)', x_rollout2[:,1])
    ...
    plt.legend(prop = {'size':10},bbox_to_anchor=(0.3,0.4),ncols=2)
