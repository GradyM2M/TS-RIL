...
if __name__ == "__main__":
    ...
    # 生成泛化轨迹
    x_rollout, _, _ = dmp.rollout(x0=[16,3.5,3],xT=[14.75,3.7,3])
    x_rollout2, _, _ = dmp.rollout_ECDMP(x0=[16,3.5,3],xT=[14.75,3.7,3])

    np.savetxt(r'D:\大论文\实验代码\Joing_dmps\numerical_test\case2\x_des', x_des)
    np.savetxt(r'D:\大论文\实验代码\Joing_dmps\numerical_test\case2\dmp', x_rollout)
    np.savetxt(r'D:\大论文\实验代码\Joing_dmps\numerical_test\case2\ec-dmp', x_rollout2)
    ...
    plt.savefig('case2-2.png',dpi=600)
    plt.show()
