...
disp('DIDSSG-RRT* Algorithm is executing...')

% 加载 3D 栅格地图
mapData = load('3DMap_02.mat');
...
% 定义起始点和目标点
% Map03_01
% start_vertex = [70, 70, 3];
% goal_vertex = [70, 10, 8];

% Map03_02
start_vertex = [10, 50, 3];
goal_vertex = [10, 30, 8];
